...
def validate_document_sync(errors: list[str]) -> None:
    ...
    if len(requirement_ids) != 32:
        fail(errors, f"Expected 32 baseline requirements, found {len(requirement_ids)}")
...
def main() -> int:
    ...
    print("- Frozen EDRs indexed: 13")
    print("- baseline RTM/acceptance pairs: 32")
    return 0
